      ...
      <div id="proyects" className="proyectsContainer">
        ...
        <div className="proyectContainer" >
          ...
          <div className="infoContainer">
            <h2 data-aos="fade-up">Mi portfolio fotográfico</h2>
            ...
            <a data-aos="fade-up" className='linkButton'target='_blank' href="https://jbertuggia.github.io/proyectoWebFinal/">Link al proyecto</a>
          </div>
        ...
        <div className="proyectContainer" >
          <div className="infoContainer">
            <h2 data-aos="fade-up">E-Commerce de informática "PC LUX"</h2>
            ...
            <a data-aos="fade-up" className='linkButton' target='_blank' href="https://proyecto-final-react-plum.vercel.app/">Link al proyecto</a>
          </div>
          <div data-aos="fade-up" className='videoContainer'>
